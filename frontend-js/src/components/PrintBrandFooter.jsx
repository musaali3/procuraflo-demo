...
export function printFooterRules(){
 return prepared ||= (async()=>{
  ...
  return `${DOCUMENT_FOOTER_RULES} @bottom-left {content:url("${canvas.toDataURL('image/png')}") "\\A ${PRODUCT_BRAND.name} - ${DOCUMENT_THEME.tagline}";white-space:pre;text-align:left;vertical-align:middle;font:6.5pt Arial,sans-serif;color:#526671;}`;
 })();
}
